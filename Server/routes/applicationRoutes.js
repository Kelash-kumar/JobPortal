...
router.route('/applied').get(authenticateUser,authorizedUser("student"),getAppliedJobs);
router.route('/applied/:id').get(authenticateUser,authorizedUser("recruiter"),getApplications);//company can see all applications for a job
